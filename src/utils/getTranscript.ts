  ...
  try {
    const result = await model.generateContent([
      ...
      },
      {
        ...
        Content Selection:
        Focus on moments likely to engage viewers or resonate emotionally to increase viral potential.
        Prioritize humorous, insightful, or dramatic content.
        Subtitle Structure:
        ...
        Formatting Rules:
        Output should always be a JSON array without enclosing it in backticks or any additional formatting.
        Avoid adding any explanations, comments, or metadata outside the JSON structure.
